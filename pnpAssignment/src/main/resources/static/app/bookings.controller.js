		...
		//Get The Product Category
		   getCategory();
			...
			//Get All The Products based on the Product Code
	  		...
	  		$scope.getProducts = function(bnvnbvb) 
	  		{
	  	
	  			var proname = bnvnbvb.productCategoryCode;
	  			console.log(proname);
	  			
	  			$http({
	  				method : 'GET',
	  				url : '/GetAllProducts/' +proname
	  			}).then(function successCallback(response) {
...
console.log(UpdateOrder);
	...
	$scope.AddDriver = function() {
		...
		var DriverInfor = 
		{
			"driverSurname" : 	$scope.DriverForm.driverSurname,
			"driverName" : $scope.DriverForm.driverName,
